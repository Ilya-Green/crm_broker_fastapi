...
class Role(SQLModel, table=True):
    ...
    outputs_can_access: bool = Field(default=0)
...
class Trader(SQLModel, table=True):
    ...
    mainBalance: Optional[float] = Field(default=0)
    bonuses: Optional[float] = Field(default=0)
    credFacilities: Optional[float] = Field(default=0)
